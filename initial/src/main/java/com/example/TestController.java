...
public class TestController {
    ...
    //映射路径http://.../test/pass?id=123&name=tom
    @ResponseBody
    public String passObj(Account account, HttpServletRequest request) {
        System.out.println("对象的id和名称分别为为：" + account.getId() + "/" + account.getName());
        return "url:" + request.getRequestURL() + " 可以访问此方法";
